...
{
    [Concept]
    public class QuestionsConcept : Concept
    {
        // --------------------------------------------------------------------------------------------------------------------

        public QuestionsConcept(Brain brian)
            : base(brian)
        {
        ...
        public readonly DictionaryItem Who;
        public readonly DictionaryItem What;
        public readonly DictionaryItem When;
        public readonly DictionaryItem Where;
        public readonly DictionaryItem Why;
        public readonly DictionaryItem How;
        public readonly DictionaryItem Are;
        public readonly DictionaryItem Is;
        public readonly DictionaryItem If;
        public readonly DictionaryItem Can;
        ...
        async Task<bool> _What_Excl_Intent(ConceptHandlerContext context)
        {
        ...
        async Task<bool> _What_Intent(ConceptHandlerContext context)
        {
        ...
        [IntentHandler("How")]
        async Task<bool> _How_Intent(ConceptHandlerContext context)
        {
            if (context.WasPrevious(null))
