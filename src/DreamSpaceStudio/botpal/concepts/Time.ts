...
{
    [Concept]
    public class TimeConcept : Concept
    {
        // --------------------------------------------------------------------------------------------------------------------

        public TimeConcept(Brain brian)
            : base(brian)
        {
        ...
        public readonly DictionaryItem Time;
        ...
        async Task<bool> _Time_Intent(ConceptHandlerContext context)
        {
