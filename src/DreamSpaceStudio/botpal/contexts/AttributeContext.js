...
(function (BotPal) {
    ...
    Context;
    {
        DictionaryItem;
        Name;
        AttributeContext(Memory, memory, Concept, concept, DictionaryItem, attributeName, Context, parent = null);
        base(memory, concept, parent);
        {
            Name = attributeName;
        }
        AttributeContext(Concept, concept, DictionaryItem, attributeName, Context, parent = null);
        this(concept.Memory, concept, attributeName, parent);
        {
        }
        // --------------------------------------------------------------------------------------------------------------------
    }
