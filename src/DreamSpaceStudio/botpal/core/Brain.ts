...
namespace BotPal
{
    public delegate Task ResponseHandler(Brain brain, Response response);
    ...
    public class Brain
    {
        ...
        public Regex LanguageParsingRegex = new Regex("\".*?\"|'.*?'|[A-Za-z']+|[0-9]+|\\s+|.", RegexOptions.Multiline);
