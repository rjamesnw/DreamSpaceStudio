...
export default class Dictionary implements IMemoryObject {
    ...
    /// </summary>
    _TextIndexByFirstLetter: Map<char, List<TextPart>> = new Map<char, List<TextPart>>(); // TODO: Consider restricting on max word length as well.
    ...
    /// </summary>
    _SimilarTexts: Map<string, List<TextPart>> = new Map<string, List<TextPart>>();
    ...
    /// </summary>
    Dictionary<string, List <DictionaryItem>> _SimilarEntries = new Map<string, List<DictionaryItem>>();
