import { IEquality } from "../core/Comparer";

export default class Point3D implements IEquality {
    /// <summary>
     ...
     * @returns
     */
    static parse(source: string): Point3D {
        source = ('' + (source ?? '')).trimLeftChar('(').trimRightChar(')');
