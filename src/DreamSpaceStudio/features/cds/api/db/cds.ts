import { DbContext } from './models/Common/DbContext';
import { DbSet } from './models/Common/DbSet';
import { AppPartition } from './models/AppPartition';

export class CDSContext extends DbContext<DS.DB.MySQL.MySQLAdapter> {
    get Actions(): DbSet<Action> { return null; }
    get Applications(): DbSet<Application> { return null; }
    get AppPartitions(): DbSet<AppPartition> { return null; }
    get AuditLog(): DbSet<AuditLogItem> { return null; }
    get Application_Membership_Role_Mapping(): DbSet<Application_Membership_Role_Map> { return null; }
    get User_Organization_Mapping(): DbSet<User_Organization_Map> { return null; }
    get Memberships(): DbSet<Membership> { return null; }
    get Organizations(): DbSet<Organization> { return null; }
    get PaymentProcessors(): DbSet<PaymentProcessor> { return null; }
    get PaymentStatuses(): DbSet<PaymentStatus> { return null; }
    get Payments(): DbSet<Payment> { return null; }
    get Roles(): DbSet<Role> { return null; }
    get SubscriptionModels(): DbSet<SubscriptionModel> { return null; }
    get SubscriptionProperties(): DbSet<SubscriptionProperty> { return null; }
    get SubscriptionPropertyValues(): DbSet<SubscriptionPropertyValue> { return null; }
    get Subscriptions(): DbSet<Subscription> { return null; }
    get Users(): DbSet<User> { return null; }
    get Organization_User_Application_Membership_Mapping(): DbSet<Organization_User_Application_Membership_Map> { return null; }
    get Subscription_SubUser_Mapping(): DbSet<Subscription_User_Map> { return null; }
    get SavedBillingAddresses(): DbSet<SavedBillingAddress> { return null; }
    get SavedCreditCardInfos(): DbSet<SavedCreditCardInfo> { return null; }
    get Subscription_Models_Applications_Map(): DbSet<Subscription_Models_Applications_Map> { return null; }
    get SessionData(): DbSet<SessionStore> { return null; }
}
