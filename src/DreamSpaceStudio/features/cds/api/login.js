...
async function post(req, res, next) {
    ...
    try {
        ...
        if (!isAdmin) {
            let staffResuts = await cds_1.getStaff(username);
        ...
        var siteResults = await cds_1.getSite(username != "adventsunsupport" ? void 0 : 1); // (always authenticate support on the SRHC AD)
