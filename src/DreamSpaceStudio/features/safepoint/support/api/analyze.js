...
async function get(req, res, next) {
    ...
    try {
        ...
        for (var staff of staffResuts.response) {
            ...
            var incidents = await sp_db.query(`select IncidentID, Status, IsInactive, IncidentSeverities.Description as SeverityDescription, IncidentSeverityGroups.Name as Severity, IncidentSeverityGroups.Display as SeverityDisplay FROM Incidents
            ...
            var incident = ((_a = incidents.response) === null || _a === void 0 ? void 0 : _a.length) ? incidents.response[0] : null;
            if (incident) {
