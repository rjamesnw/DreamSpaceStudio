...
// ###########################################################################################################################
define(["require", "exports", "./DreamSpace", "./Logging", "./Factories", "./Resources", "./PrimitiveTypes", "./TSHelpers", "./System/Exception", "./Globals", "./ErrorHandling", "./Utilities", "./ResourceRequest", "./Path"], function (require, exports, DreamSpace_1, Logging_1, Factories_1, Resources_1, PrimitiveTypes_1, TSHelpers_1, Exception_1, Globals_1, ErrorHandling_1, Utilities_1, ResourceRequest_1, Path_1) {
    "use strict";
