...
// ###########################################################################################################################
define(["require", "exports", "./DreamSpace", "./Exception", "./Browser"], function (require, exports, DreamSpace_1, Exception_1, Browser_1) {
    "use strict";
        ...
        */
        ...
        [DreamSpace_1.DreamSpace.constructor](factory) {
            ...
            */
            ...
            Delegate.prototype.call = ((Browser_1.Browser.type != Browser_1.Browser.BrowserTypes.IE) ?
            ...
            Delegate.prototype.apply = ((Browser_1.Browser.type != Browser_1.Browser.BrowserTypes.IE) ? Delegate.prototype.__apply : makeCases(0, 20, apply, "$this.__boundFunc", "", "args")); // (note: bound functions are faster in IE)
        }
