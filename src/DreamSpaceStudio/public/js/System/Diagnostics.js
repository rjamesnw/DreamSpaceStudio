...
// ############################################################################################################################
define(["require", "exports", "./DreamSpace", "./Time", "./Exception", "./Logging", "./Text"], function (require, exports, DreamSpace_1, Time_1, Exception_1, Logging_1, Text_1) {
    "use strict";
    ...
    (function (Diagnostics) {
        ...
        function getLogAsHTML() {
            ...
            for (i = 0, n = orderedLogItems.length; i < n; ++i) {
                ...
                if (cssAndIcon.cssClass)
                    messageHTML = cssAndIcon.icon + "<strong>" + Text_1.StringUtils.replace(logItem.message, "\r\n", "<br />\r\n") + "</strong>";
                else
        ...
        function getLogAsText() {
            ...
            return Text_1.StringUtils.replaceTags(Text_1.StringUtils.replace(getLogAsHTML(), "&nbsp;", " "));
        }
