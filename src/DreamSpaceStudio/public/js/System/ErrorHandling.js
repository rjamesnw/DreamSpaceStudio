define(["require", "exports", "./Diagnostics", "./Utilities"], function (require, exports, Diagnostics_1, Utilities_1) {
    "use strict";
    ...
    function getErrorMessage(errorSource) {
        if (typeof errorSource == 'string')
            ...
            if (Diagnostics_1.Diagnostics && Diagnostics_1.LogItem && errorSource instanceof Diagnostics_1.LogItem) {
