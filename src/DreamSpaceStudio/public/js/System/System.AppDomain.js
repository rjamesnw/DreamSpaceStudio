...
(function (DreamSpace) {
    ...
    (function (System) {
         ...
         */
        class AppDomain extends FactoryBase(System.CoreObject) {
            /** The default system wide application domain.
              * See 'System.Platform.AppDomain' for more details.
              */
            static get default() { return AppDomain._default; }
            static set default(value) {
                if (!value || !(value instanceof this.$__type))
                    error("AppDomain.default", "A valid 'AppDomain' instance is required.");
                this._default = value;
            }
        }
            ...
            class $__type extends FactoryType(System.CoreObject) {
                ...
                with(type) {
                    ...
                    if (!typeInfo.$__parent || !typeInfo.$__name || !typeInfo.$__fullname)
                        throw System.Exception.error("with()", "The specified type has not yet been registered properly. Extend from 'DreamSpace.ClassFactory()' or use utility functions in 'DreamSpace.Types' when creating factory types.", type);
        ...
        /** Applications wrap window reference targets, and any specified HTML for configuration and display. There can be many
          ...
          */
        class Application extends FactoryBase(System.CoreObject) {
            // -------------------------------------------------------------------------------------------------------------------------------
            /** The default system wide application domain.
              * See 'System.Platform.AppDomain' for more details.
              */
            static get default() { return Application._default; }
            static set default(value) {
                if (!value || !(value instanceof Application.$__type))
                    error("Application.default", "A valid 'Application' instance is required.");
...
//# sourceMappingURL=System.AppDomain.js.map