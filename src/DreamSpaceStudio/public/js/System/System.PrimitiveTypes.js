...
(function (DreamSpace) {
    ...
    (function (System) {
        ...
        class CoreObject extends FactoryBase(void 0, global.Object) {
            /**
        ...
        CoreObject.s = 3;
        System.CoreObject = CoreObject;
        (function (CoreObject) {
            class $__type extends DisposableFromBase(global.Object) {
                // -------------------------------------------------------------------------------------------------------------------
                ...
                */
                static getTypeName(object, cacheTypeName = true) {
                    this.getTypeName = DreamSpace.getTypeName;
                    return DreamSpace.getTypeName(object, cacheTypeName);
                }
        ...
        })(CoreObject = System.CoreObject || (System.CoreObject = {}));
        // =======================================================================================================================
        ...
        class String extends FactoryBase(void 0, global.String) {
            ...
            static replace(source, replaceWhat, replaceWith, ignoreCase) {
                ...
                if (ignoreCase)
                    return source.replace(new RegExp(DreamSpace.Utilities.escapeRegex(replaceWhat), 'gi'), replaceWith);
                    ...
                    return source.replace(new RegExp(DreamSpace.Utilities.escapeRegex(replaceWhat), 'g'), replaceWith);
            }
        ...
        (function (String) {
            class $__type extends DisposableFromBase(global.String) {
         ...
         */
        class Array extends FactoryBase(void 0, global.Array) {
        }
        System.Array = Array;
        (function (Array) {
            class $__type extends DisposableFromBase(global.Array) {
...
//# sourceMappingURL=System.PrimitiveTypes.js.map