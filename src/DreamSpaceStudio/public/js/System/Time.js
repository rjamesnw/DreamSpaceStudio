...
// ###########################################################################################################################
define(["require", "exports", "./DreamSpace", "./Exception", "./Text"], function (require, exports, DreamSpace_1, Exception_1, Text_1) {
    "use strict";
    ...
    class TimeSpan {
        ...
        static utcTimeToLocalTime(timeInMs) {
            return new TimeSpan((timeInMs || 0) - DreamSpace_1.DreamSpace.Time.__localTimeZoneOffset);
        }
        ...
        static getTimeZoneSuffix(timezoneOffsetInMs = DreamSpace_1.DreamSpace.Time.__localTimeZoneOffset) {
            ...
            return "UTC" + (tzInHours >= 0 ? "+" : "-")
                + Text_1.StringUtils.pad(Math.floor(hours), 2, '0')
                + Text_1.StringUtils.pad(Math.floor(hours % 1 * DreamSpace_1.DreamSpace.Time.__minsPerHour), 2, '0');
        }
        ...
        static getISOTimeZoneSuffix(timezoneOffsetInMs = DreamSpace_1.DreamSpace.Time.__localTimeZoneOffset) {
            ...
            return (tzInHours >= 0 ? "+" : "-")
                + Text_1.StringUtils.pad(hours, 2, '0') + ":"
                + Text_1.StringUtils.pad(minutes, 2, '0') + ":"
                + Text_1.StringUtils.pad(Math.floor(seconds), 2, '0') + "."
                + Text_1.StringUtils.pad(Math.floor(seconds % 1 * 1000), 3, null, '0') // (1000th decimal precision)
                + "Z";
        }
        //  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .
        ...
        toString(includeTime = true, includeMilliseconds = true, includeTimezone = true) {
            if (!this.__localTS)
                this.__localTS = new TimeSpan(this.toValue() - DreamSpace_1.DreamSpace.Time.__localTimeZoneOffset);
            var localTS = this.__localTS;
            return "Year " + Text_1.StringUtils.pad(localTS.year, 4, '0') + ", Day " + Text_1.StringUtils.pad(localTS.dayOfYear, 3, '0')
                + (includeTime ? " " + Text_1.StringUtils.pad(localTS.hours, 2, '0') + ":" + Text_1.StringUtils.pad(localTS.minutes, 2, '0') + ":" + Text_1.StringUtils.pad(localTS.seconds, 2, '0')
        ...
        toUTCString(includeTime = true, includeMilliseconds = true) {
            return "Year " + Text_1.StringUtils.pad(this.year, 4, '0') + ", Day " + Text_1.StringUtils.pad(this.dayOfYear, 3, '0')
                + (includeTime ? " " + Text_1.StringUtils.pad(this.hours, 2, '0') + ":" + Text_1.StringUtils.pad(this.minutes, 2, '0') + ":" + Text_1.StringUtils.pad(this.seconds, 2, '0')
        ...
        toISODateString(includeTime = true, includeMilliseconds = true, includeTimezone = true) {
            ...
            return Text_1.StringUtils.pad(this.__date.getFullYear(), 4, '0') + "-" + Text_1.StringUtils.pad(1 + this.__date.getMonth(), 2, '0') + "-" + Text_1.StringUtils.pad(this.__date.getDate(), 2, '0')
                + (includeTime ? "T" + Text_1.StringUtils.pad(this.__date.getHours(), 2, '0') + ":" + Text_1.StringUtils.pad(this.__date.getMinutes(), 2, '0') + ":" + Text_1.StringUtils.pad(this.__date.getSeconds(), 2, '0')
        ...
        toUTCISODateString(includeTime = true, includeMilliseconds = true, includeTimezone = true) {
            if (!this.__date)
                this.__date = new Date(this.toValue());
            return Text_1.StringUtils.pad(this.year, 4, '0') + "-" + Text_1.StringUtils.pad(1 + this.__date.getUTCMonth(), 2, '0') + "-" + Text_1.StringUtils.pad(this.__date.getUTCDate(), 2, '0')
                + (includeTime ? "T" + Text_1.StringUtils.pad(this.hours, 2, '0') + ":" + Text_1.StringUtils.pad(this.minutes, 2, '0') + ":" + Text_1.StringUtils.pad(this.seconds, 2, '0')
                    + (includeMilliseconds && this.milliseconds ? "." + this.milliseconds : "")
