define(["require", "exports", "./TrackableObject", "./Events", "./Security"], function (require, exports, TrackableObject_1, Events_1, Security_1) {
    "use strict";
     ...
     */
    class User extends TrackableObject_1.TrackableObject {
    ...
    User.onCurrentUserChanging = new Events_1.EventDispatcher(User, "onCurrentUserChanging");
    /** Triggered when the current user has changed. This event cannot be cancelled - use the 'onCurrentUserChanging' event for that. */
    User.onCurrentUserChanged = new Events_1.EventDispatcher(User, "onCurrentUserChanged", false, false);
    exports.User = User;
    // ############################################################################################################################
