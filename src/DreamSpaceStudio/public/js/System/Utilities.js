define(["require", "exports"], function (require, exports) {
    ...
    */
    exports.global = (function () { }.constructor("return this || global"))(); // (note: this is named as 'global' to support the NodeJS "global" object as well [for compatibility, or to ease portability])
    // =======================================================================================================================
    ...
    (function (Utilities) {
        ...
        */
        function dereferencePropertyPath(path, origin, unsafe = false) {
            if (unsafe)
                return safeEval('p0.' + path, origin); // (note: this is 'DreamSpace.eval()', not a direct call to the global 'eval()')
            if (origin === void 0 || origin === null)
                origin = this !== exports.global ? this : exports.global;
        ...
        */
        ...
        var _guidSeed = (function () {
            var text = exports.global.navigator.userAgent + exports.global.location.href; // TODO: This may need fixing on the server side.
