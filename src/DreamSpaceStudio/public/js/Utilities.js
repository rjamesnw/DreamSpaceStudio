...
(function (Utilities) {
    ...
    Core_1.DreamSpace.namespace("DreamSpace", "Utilities");
    // -------------------------------------------------------------------------------------------------------------------
    ...
    */
    function dereferencePropertyPath(path, origin, unsafe = false) {
        ...
        if (origin === void 0 || origin === null)
            origin = this !== global ? this : global;
        ...
        if (n)
            ((c = path[i++]) == '.' || c == '[' || c == ']' || c == void 0)
                ...
                : name += c;
        if (i == n + 2)
            throw System.Exception.from("Invalid path: " + path, origin);
...
Core_1.DreamSpace.Utilities = Utilities;
var DreamSpace = Core_1.DreamSpace;
