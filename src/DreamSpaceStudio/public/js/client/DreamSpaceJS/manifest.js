...
//       Include a 'manifest.ts' file with your 'app.ts' file and simply create a "module DreamSpace.Scripts.Modules.??? { }" block in the manifest with your own
...
//       manifest file in their TS projects (and of course add the script tag to load "DreamSpace.js").  The manifest simply contains your own "Modules" list.
//
// 2. In a JavaScript file ('.js', i.e. outside TypeScript), simply add your domain/alias namespace name to the "DreamSpace.Scripts.Modules" object
//    (ex: "DreamSpace.Scripts.Modules.MyDomain = {};"), then register the module's type name (such as
//    "DreamSpace.Scripts.Modules.MyDomain.MyModuleName = DreamSpace.Scripts.Modules.registerModule(...);").
//
// In all cases, you have two options to load a module:
// 1. By calling "DreamSpace.Scripts.Modules.using(DreamSpace.Modules.$_Namespace.Module_Name)" (dynamic loading/load on demand).
    ...
    (function (Scripts) {
        ...
        (function (Modules) {
            ...
            (function (System) {
                ...
                System.Collections_IndexedObjectCollection = module([], '.Collections.IndexedObjectCollection{min:.min}');
                /** A special collection that allows observing changes (such as add/remove operations). */
                System.Collections_ObservableCollection = module([], '.Collections.ObservableCollection{min:.min}');
                /** References all collections. */
                System.Collections = module([], '.Collections{min:.min}');
                /** The core DreamSpace system. */
                System.Core = module([System.Collections_IndexedObjectCollection], '.System{min:.min}', null);
                /** The core DreamSpace system. */
                System.AppDomain = module([System.Core], '.System.AppDomain{min:.min}', null);
                /** The core DreamSpace system. */
                System.Events = module([System.Core], '.Events{min:.min}', null);
                /** System functions and types to help manage the IO process (page and data loading). */
                System.IO = module([System.Core], '.System.IO{min:.min}', null);
                /** Contains specialized classes and functions for dealing with mark-up type code (i.e. HTML, XML, etc.). */
                System.Markup = module([], '.System.Markup{min:.min}');
                ...
                */
                System.Platform = module([System.Collections, System.Markup], '.System.Platform{min:.min}', null);
                /** The main DreamSpace system core.  This module is already included by default, and is here only for consistency. */
                System.UI = module([System.Platform], '.System.Platform.UI{min:.min}.js', null);
                ...
                */
                System.UI_HTML = module([System.UI], '.System.UI.HTML{min:.min}', null); // ('.' will cause 'DreamSpace' to be prefixed automatically)
                /** This module contains types and functions for common communication tasks. */
                System.Net = module([System.Collections], '.System.Net{min:.min}', null);
                ...
                */
                System.ICE = module([System.Platform], '.System.ICE{min:.min}', null);
                /** This module contains types and functions for common data manipulation tasks. */
                System.Data = module([], '.System.Data{min:.min}', null); // JSON stuff
                // -------------------------------------------------------------------------------------------------------------------
