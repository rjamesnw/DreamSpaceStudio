...
export default class HTMLReader {
    ...
    */
    ...
    constructor(private html: string) {
        ...
        this.delimiters = this.html.match(HTMLReader.__splitRegEx); // (get delimiters [inverse of 'split()'])
        this.nonDelimiters = (<any>this.html).split(HTMLReader.__splitRegEx, void 0, this.delimiters); // (get text parts [inverse of 'match()'])
    }
    ...
    */
    ...
    throwError(msg: string) {
        ...
        throw msg + " on line " + this.getCurrentLineNumber() + ": <br/>\r\n" + this.getCurrentRunningText();
    }
    ...
    readNext() {
        ...
        while (this.readMode != HTMLReaderModes.End) {
            ...
            //    this.readMode = HTMLReaderModes.TemplateToken;
            //    break;
            //}
            this.__readNext();
        };
