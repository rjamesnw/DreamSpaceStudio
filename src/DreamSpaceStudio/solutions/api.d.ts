...
declare namespace DS {
    namespace IO {
        ...
        class Response<TData = any> {
            ...
            constructor(message?: string, data?: any, httpStatusCode?: HttpStatus, notSerializable?: boolean);
            static fromError(message: string, error: any, httpStatusCode?: HttpStatus, data?: any): Response<any>;
        }
...
declare namespace DS {
    ...
    class Project extends TrackableObject {
        ...
        readonly files: {
            [index: string]: VirtualFileSystem.File;
        };
