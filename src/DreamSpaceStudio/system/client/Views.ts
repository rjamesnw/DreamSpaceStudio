namespace DS.UI {
    export interface IHTTPViewRequestListener { (view: View, request: DS.ResourceRequest): void }
    ...
    export class View extends ViewBase {
        ...
        static loadedView: View; // (used for script executions after loading views; this is undefined otherwise)
         ...
         */
        constructor(name: string, url?: string, query?: IndexedObject, parent?: Views);
        /**
        ...
        constructor(name: string, urlOrElement?: string | HTMLElement, public queryOrChildrenOnly?: IndexedObject | boolean, parent?: Views) {
            super();
            ...
            if (urlOrElement instanceof Node && urlOrElement.nodeName == "HTML") {
                ...
                if (urlOrElement instanceof HTMLElement) {
                    ...
                    this._request = new ResourceRequest(this._url, ResourceTypes.Text_HTML, "POST", <IndexedObject>queryOrChildrenOnly);
                }
            }
        ...
        thenLoad(name: string, url: string, payload?: IndexedObject, delay = 0): View {
            var view = this.parent.createView(name, url, payload);
            view._request = this._request.include(new ResourceRequest(url, this._request.type, this._request.method, payload, delay));
            return view;
        }

        // --------------------------------------------------------------------------------------------------------------------

        send(): View { this._request.start(); return this; }
    ...
    export class Views extends ViewBase {
         ...
         */
        createView(name: string, url?: string, payload?: IndexedObject, rootNode?: HTMLElement): View {
