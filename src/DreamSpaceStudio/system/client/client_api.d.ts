...
declare namespace DS {
    ...
    class Page extends Abstracts.Page implements IResourceSource {
...
declare namespace DS {
    class Project extends Abstracts.Project {
    }
}
declare namespace DS {
    /**
    ...
    */
    class Solution extends Abstracts.Solution {
    }
    abstract class Solutions extends Abstracts.Solutions {
        ...
        static load(fm?: VirtualFileSystem.FileManager): Promise<typeof Solutions>;
    }
}
declare namespace DS {
    namespace VirtualFileSystem {
        class Directory extends Abstracts.Directory {
        }
...
//# sourceMappingURL=client_api.d.ts.map