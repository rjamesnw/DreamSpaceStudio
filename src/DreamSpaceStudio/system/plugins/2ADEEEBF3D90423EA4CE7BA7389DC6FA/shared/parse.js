...
var nameOf_Templating_Phrase_phraseType = DS.Utilities.nameof(() => modules_1.Templating.Phrase.prototype.phraseType);
var nameOf_Templating_Header_headerLevel = DS.Utilities.nameof(() => modules_1.Templating.Header.prototype.headerLevel);
...
function parse(html = null, strictMode) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        var HTMLReader = (yield Promise.resolve().then(() => require("./HTMLReader"))).HTMLReader;
        var HTMLReaderModes = (yield Promise.resolve().then(() => require("./HTMLReader"))).HTMLReaderModes;
        ...
        response = new DS.IO.Response(null, { rootElements: rootElements, templates: globalTemplatesReference }, 200 /* OK */, true);
        return response;
    });
}
exports.parse = parse;
