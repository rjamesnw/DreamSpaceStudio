...
(function (DreamSpace) {
    ...
    */
    ...
    function init() {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((initCompleted) => __awaiter(this, void 0, void 0, function* () {
                ...
                (yield Promise.resolve().then(() => require("./Logging"))).log("DreamSpace.init()", "Initialized and ready.");
                initCompleted();
            }));
        });
    }
    ...
    __onInit(() => __awaiter(this, void 0, void 0, function* () {
        var logging = yield Promise.resolve().then(() => require("./Logging"));
        var path = yield Promise.resolve().then(() => require("./Path"));
