...
interface IHostBridge {
    ...
    ///** Returns true if 'host' in the global scope represents the DreamSpace Studio .NET environment (which implements CEF [the Chrome Embedded Framework]). */
    ...
    */
    ...
    /** Returns true if this script is running in the DreamSpace Studio host. */
    isStudio(): boolean;
