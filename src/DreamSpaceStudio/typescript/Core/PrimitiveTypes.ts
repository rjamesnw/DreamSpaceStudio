...
@factory(this)
class ObjectFactory extends DS.global.Object implements IDisposable, ISerializable { // (FACTORY; 'extends DS.global.Object' is only for clarity)
    /**
    ...
    */
    static init(o: ObjectFactory, isnew: boolean, value?: any, makeValuePrivate?: boolean): void {
    ...
    getTypeInfo(): IFunctionInfo {
        if (!(<ITypeInfo><any>this.constructor).$__name && (<typeof ObjectFactory><any>this.constructor).getTypeName)
            (<typeof ObjectFactory><any>this.constructor).getTypeName(this); // (make sure name details exist; if not, this will add it before continuing)
    ...
    private $__reset(): this {
        ...
        var instance = <ObjectFactory & ITypeInfo & IDomainObjectInfo>ObjectFactory.init.call(this, this, false, ...arguments);
...
export { ObjectFactory as Object }
...
export abstract class DependentObject extends ObjectFactory {
