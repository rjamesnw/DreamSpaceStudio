...
*/
class IndexedObjectCollectionFactory extends Factory(Array) {
...
@usingFactory(IndexedObjectCollectionFactory, this)
class IndexedObjectCollection<TObject extends IndexedObject> extends ArrayInstance<TObject> {
    // -------------------------------------------------------------------------------------------------------------------------------
     ...
     */
    __IDPropertyName = IndexedObjectCollectionFactory.__IDPropertyName;
