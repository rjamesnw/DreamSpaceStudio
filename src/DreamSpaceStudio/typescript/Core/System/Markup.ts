...
export class HTMLReader extends Factory(Object) {
    ...
    static init(o: IHTMLReader, isnew: boolean, html: string) {
        ...
        o.nonDelimiters = (<any>o.html).split(HTMLReader.__splitRegEx, void 0, o.delimiters); // (get text parts [inverse of 'match()']; last argument is ignored on newer systems [see related polyfill in DreamSpace.Browser])
    }
