...
import { DreamSpace as DS, IFactory } from "../DreamSpace";
...
export class GraphNode extends Factory(PropertyEventBase) {
    /**
    ...
    */
    static registerProperty(factory: IFactory, name: string, isVisual: boolean = false,
        ...
        var currentSP: IArray<IStaticProperty> = (<Object>factory)['__staticProperties'];

        if (currentSP === void 0) {
            (<Object>factory)['__staticProperties'] = currentSP = Array.new<IStaticProperty>();
            ...
            (<Object>factory)['__staticProperties'] = currentSP = typeSpecificSP;
        }
    ...
    */
    ...
    on(eventName: string, handler: (ev: Event) => any) {
        ...
        if (existingEvent === void 0)
            this.__events[eventName] = existingEvent = EventDispatcher.new<IGraphNode, (ev: Event) => any>(this, eventName);
    ...
    */
    ...
    private static [DS.constructor](factory: typeof GraphNode) {
