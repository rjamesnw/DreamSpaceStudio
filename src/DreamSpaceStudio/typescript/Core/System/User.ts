...
export class User extends Object {
    ...
    static readonly onCurrentUserChanging = EventDispatcher.new<typeof User, (oldUser: User, newUser: User) => boolean>(User, "onCurrentUserChanging");

    /** Triggered when the current user has changed. This event cannot be cancelled - use the 'onCurrentUserChanging' event for that. */
    static readonly onCurrentUserChanged = EventDispatcher.new<typeof User, (oldUser: User, newUser: User) => void>(User, "onCurrentUserChanged", false, null, false);
