define(["require", "exports", "./System/Storage", "./System/Text", "./System/User", "./System/PrimitiveTypes"], function (require, exports, Storage_1, Text_1, User_1, PrimitiveTypes_1) {
    "use strict";
    ...
    (function (FileSystem) {
        ...
        class FileManager {
            ...
            static get currentUser() { if (User_1.User.current)
                return User_1.User.current; throw "'FlowScript.currentUser' is required!"; } // (added for convenience, and to make sure TS knows it needs to be defined before this class)
        ...
        function combine(path1, path2) {
            return PrimitiveTypes_1.String.append(path1, path2, '/');
        }
