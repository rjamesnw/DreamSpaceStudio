...
import { DreamSpace as DS, IDreamSpace as IDS } from "./Utilities";
 ...
 */
namespace Globals { //http://jsperf.com/string-concat-vs-nested-object-lookups
    namespace("DreamSpace", "Globals");
    /** Internal: used when initializing DreamSpace. */
    var _globals: IndexedObject = DreamSpace.Globals;
...
export interface IDreamSpace extends IDS { Globals: typeof Globals }
(<IDreamSpace>DS).Globals = Globals;
