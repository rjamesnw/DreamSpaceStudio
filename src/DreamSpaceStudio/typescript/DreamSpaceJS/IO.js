...
(function (IO) {
    ...
    class ResourceRequest extends Types_1.Factory() {
        ...
        static set cacheBustingVar(value) { this._cacheBustingVar = Utilities_1.default.toString(value) || '_v_'; }
        ;
        /** Disposes this instance, sets all properties to 'undefined', and calls the constructor again (a complete reset). */
        static init(o, isnew, url, type, async) {
        ...
        get url() {
            if (typeof this._url == 'string' && this._url.charAt(0) == "~") {
                ...
                return Path_1.default.resolve(this._url, void 0, _baseURL);
            }
            return this._url;
        }
        ...
        _Start(_method, _body, _username, _password) {
            ...
            if (this.status == Resources_1.RequestStatuses.Pending) {
                ...
                if (!Globals_1.DreamSpace.isDebugging() && typeof Storage !== void 0)
                    try {
                    ...
                    var loaded = () => {
                        if (xhr.status == 200 || xhr.status == 304) {
                            ...
                            if (this.type && responseType && this.type != responseType) {
                                ...
                                if (!Globals_1.DreamSpace.isDebugging() && typeof Storage !== void 0)
                                    try {
                                        localStorage.setItem("version", Globals_1.DreamSpace.version);
                                        localStorage.setItem("appVersion", Globals_1.DreamSpace.getAppVersion());
