...
namespace IO {
    ...
    export namespace ResourceRequest {
        export class $__type {
            ...
            private $__transformedData: any = DreamSpace.noop;
            ...
            */
            ...
            private _doError(): void { // (note: the following event link handles the preceding error, skipping first any and all 'finally' handlers)
                ...
                if (this.status == RequestStatuses.Error) {
                    ...
                    if (msgs) msgs = ":\r\n· " + msgs; else msgs = ".";
                    throw new Error("Unhandled error loading resource " + (typeof this.type == 'number' ? ResourceTypes[this.type] : this.type) + " from '" + this.url + "'" + msgs + "\r\n");
                }
            }
            ...
            private static [DreamSpace.constructor](factory: typeof ResourceRequest) {
