define(["require", "exports", "./Types", "./Utilities", "./Resources", "./Core", "./Path", "./Logging", "./ErrorHandling", "./Query"], function (require, exports, Types_1, Utilities_1, Resources_1, Core_1, Path, Logging_1, ErrorHandling_1, Query_1) {
    "use strict";
                ...
                if (this.status == Resources_1.RequestStatuses.Ready) {
                    if (this._onReady && this._onReady.length) {
                        try {
                            ...
                            if (isDebugging() && (this.type == Resources_1.ResourceTypes.Application_Script || this.type == Resources_1.ResourceTypes.Application_ECMAScript))
            ...
            _doError() {
                ...
                if (this.status == Resources_1.RequestStatuses.Error) {
                    ...
                    if (msgs)
                        ...
                        msgs = ".";
                    throw new Error("Unhandled error loading resource " + Resources_1.ResourceTypes[this.type] + " from '" + this.url + "'" + msgs + "\r\n");
                }
            }
