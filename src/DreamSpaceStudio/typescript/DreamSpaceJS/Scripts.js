...
// ###########################################################################################################################
define(["require", "exports", "./Globals", "./Logging", "./Types", "./Resources", "./System/PrimitiveTypes", "./TSHelpers", "./System/Exception", "./ErrorHandling", "./Utilities", "./ResourceRequest", "./Path"], function (require, exports, Globals_1, Logging_1, Types_1, Resources_1, PrimitiveTypes_1, TSHelpers_1, Exception_1, ErrorHandling_1, Utilities_1, ResourceRequest_1, Path_1) {
    "use strict";
