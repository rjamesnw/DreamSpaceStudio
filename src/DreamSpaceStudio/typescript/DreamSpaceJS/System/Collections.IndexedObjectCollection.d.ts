declare const IndexedObjectCollection_base: any;
...
*/
export declare class IndexedObjectCollection extends IndexedObjectCollection_base {
...
export declare namespace IndexedObjectCollection {
