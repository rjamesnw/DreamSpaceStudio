...
let Delegate = Delegate_1 = class Delegate extends PrimitiveTypes_1.DSObject {
    ...
    [Globals_1.DreamSpace.constructor](factory) {
        ...
        */
        ...
        Delegate_1.prototype.call = ((Browser_1.default.type != Browser_1.default.BrowserTypes.IE) ?
        ...
        Delegate_1.prototype.apply = ((Browser_1.default.type != Browser_1.default.BrowserTypes.IE) ? Delegate_1.prototype.__apply : makeCases(0, 20, apply, "$this.__boundFunc", "", "args")); // (note: bound functions are faster in IE)
    }
