...
// ############################################################################################################################
define(["require", "exports", "../Types", "../Globals", "./System.Time", "../Logging", "./Exception", "../PrimitiveTypes"], function (require, exports, Types_1, Globals_1, System_Time_1, Logging_1, Exception_1, PrimitiveTypes_1) {
    "use strict";
    ...
    (function (Diagnostics) {
        ...
        // = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
        let LogItem = LogItem_1 = class LogItem extends Types_1.Factory(Types_1.Disposable) {
            // = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
            constructor() {
                super(...arguments);
                // --------------------------------------------------------------------------------------------------------------------------
            ...
            static init(o, isnew, parent, title, message, type = Logging_1.LogTypes.Normal, outputToConsole = true) {
                ...
                if (console && outputToConsole) { // (if the console object is supported, and the user allows it for this item, then send this log message to it now)
                    ...
                    if (System_Time_1.TimeSpan) {
                        var time = System_Time_1.TimeSpan.utcTimeToLocalTime(o.time);
            ...
            */
            ...
            toString() {
                var time = System_Time_1.TimeSpan && System_Time_1.TimeSpan.utcTimeToLocalTime(this.time) || null;
        ...
        function getLogAsHTML() {
            ...
            for (i = 0, n = orderedLogItems.length; i < n; ++i) {
                ...
                if (logItem.title)
                    ...
                    titleHTML = "";
                time = System_Time_1.TimeSpan.utcTimeToLocalTime(logItem.time);
