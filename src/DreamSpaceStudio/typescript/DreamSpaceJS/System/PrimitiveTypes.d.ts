...
declare const String_base: {
    ...
    } & typeof PrimitiveString & import("../Globals").IFactory<{
        new (...args: any[]): {
            dispose(release?: boolean): void;
        };
    } & typeof PrimitiveString, import("../Globals").NewDelegate<{
        dispose(release?: boolean): void;
...
export declare abstract class DependentObject extends DSObject {
