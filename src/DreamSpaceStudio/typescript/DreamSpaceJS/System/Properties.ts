...
@factory(this)
export class PropertyEventBase extends Factory(EventObject) {
    /**
...
export class StaticProperty extends Factory(PropertyEventBase) {
    /**
       * Creates a new basic GraphNode type.  A graph node is the base type for all UI related elements.  It is a logical
       * layout that can render a view, or partial view.
       * @param parent If specified, the value will be wrapped in the created object.
...
export class Property extends Factory(PropertyEventBase) {
    ...
    * on new UI elements during the initial layout phase.  */
    ...
    clone(): IProperty { return Property.new(this.owner, this.staticProperty, Utilities.clone(this.__value)); }
