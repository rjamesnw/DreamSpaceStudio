...
export declare class EventObject extends EventObject_base {
    /**
...
export declare namespace Browser {
    ...
    var onReady: Events.IEventDispatcher<typeof Browser, () => void>;
}
/** Triggered when all manifests have loaded. No modules have been executed at this point.
  ...
  */
export declare var onReady: Events.IEventDispatcher<typeof DreamSpace, () => void>;
export {};
