    ...
    export namespace EventDispatcher {
        export class $__type<TOwner extends object, TCallback extends EventHandler> extends DependentObject {
            ...
            */
            ...
            private static [DS.constructor](factory: typeof EventDispatcher) {
...
export namespace Browser {
    ...
    export var onReady = Events.EventDispatcher.new<typeof Browser, { (): void }>(Browser, "onReady", true);
}
...
/** Triggered when all manifests have loaded. No modules have been executed at this point.
  ...
  */
export var onReady = Events.EventDispatcher.new<typeof DreamSpace, { (): void }>(DreamSpace, "onReady", true);
