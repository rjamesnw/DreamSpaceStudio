...
namespace DreamSpace {
    ...
    export namespace Browser {
        ...
        export var onReady = System.Events.EventDispatcher.new<typeof DreamSpace.Browser, { (): void }>(DreamSpace.Browser, "onReady", true);
    }
    ...
    /** Triggered when all manifests have loaded. No modules have been executed at this point.
      ...
      */
    export var onReady = System.Events.EventDispatcher.new<typeof DreamSpace, { (): void }>(DreamSpace, "onReady", true);
