...
import { extendDSNS } from "../Types";

eval(extendDSNS(() => DreamSpaceCore));

namespace DreamSpaceCore.System {
    // =============================================================================================
...
export interface IException extends InstanceType<typeof DreamSpaceCore.System.Exception.$__type> { }

// #######################################################################################

type System = typeof DS.System & typeof DreamSpaceCore.System;
export interface IDreamSpace extends IDS { System: System; }
