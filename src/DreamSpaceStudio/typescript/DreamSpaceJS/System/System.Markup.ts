...
// ... first we must import the types we will be extending; at the end of the file we will export the new types ...
            ...
            */
            ...
            private static [constructor](factory: typeof HTMLReader) {
                factory.init = (o, isnew, html) => {
                    ...
                    o.nonDelimiters = (<any>o.html).split($__type.__splitRegEx, void 0, o.delimiters); // (get text parts [inverse of 'match()']; last argument is ignored on newer systems [see related polyfill in DreamSpace.Browser])
                };
            }
        }
...
export interface IDreamSpace extends IDS { Markup: typeof Markup; }
(<IDreamSpace>DS).Markup = Markup;
