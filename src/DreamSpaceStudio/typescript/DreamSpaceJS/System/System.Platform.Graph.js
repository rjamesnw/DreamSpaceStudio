...
(function (DreamSpace) {
    ...
    (function (System) {
        ...
        (function (Platform) {
            ...
            class GraphNode extends FactoryBase(Platform.PropertyEventBase) {
                /**
                ...
                */
                static registerProperty(factory, name, isVisual = false, changedCallback = null, changingCallback = null) {
                    ...
                    if (currentSP === void 0) {
                        factory['__staticProperties'] = currentSP = Array.new();
            ...
            */
            ...
            (function (GraphNode) {
                class $__type extends FactoryType(Platform.PropertyEventBase) {
                    constructor() {
                        // -------------------------------------------------------------------------------------------------------------------------------
                        super(...arguments);
                    ...
                    */
                    ...
                    on(eventName, handler) {
                        ...
                        if (existingEvent === void 0)
                            this.__events[eventName] = existingEvent = Events.EventDispatcher.new(this, eventName);
                ...
                global.Object.defineProperty(GraphNode, 'uiElementMap', { writable: false, configurable: false });
...
// ############################################################################################################################################
//# sourceMappingURL=System.Platform.Graph.js.map