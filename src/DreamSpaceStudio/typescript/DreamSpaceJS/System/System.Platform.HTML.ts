import { Factory, ExcludeNewInit } from "../Types";
import { IGraphNode, GraphNode } from "./Platform.Graph";
import { Diagnostics } from "./Diagnostics";
import { HTMLReaderModes } from "./Markup";
import { ITypeInfo } from "../Globals";
...
export namespace HTML {
    ...
    /** A context is a container that manages a reference to a global script environment. Each new context creates a new 
      ...
      */
    export class BrowserContext extends Factory(<ExcludeNewInit<typeof Context>>Context) {
    ...
    /** Represents an HTML node graph item that renders the content in the 'innerHTML of the default '__htmlTag' element (which is set to 'GraphItem.defaultHTMLTag' [DIV] initially).
      ...
      */
    export class HTMLElement extends Factory(HTMLNode) {
    ...
    export namespace HTMLElement<TElement extends NativeTypes.IHTMLElement = NativeTypes.IHTMLElement > extends FactoryType(HTMLNode) {
        // ----------------------------------------------------------------------------------------------------------------
