...
(function (Platform) {
     ...
     */
    class Context extends FactoryBase(DSObject) {
    ...
    /**
      ...
      */
    class UIApplication extends FactoryBase(Application) {
    ...
    (function (UIApplication) {
        class $__type extends FactoryType(Application) {
            constructor() {
                super(...arguments);
...
System_1.DreamSpace.Platform = Platform;
var DreamSpace = System_1.DreamSpace;
exports.default = DreamSpace;
//# sourceMappingURL=System.Platform.js.map