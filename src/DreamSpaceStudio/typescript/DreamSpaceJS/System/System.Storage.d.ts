...
export declare var hasLocalStorage: boolean;
/** Set to true if session storage is available. */
export declare var hasSessionStorage: boolean;
...
export declare var storagePrefix: string;
export declare function makeKeyName(appName: string, dataName: string): string;
...
*/
export declare function set(type: StorageType, name: string, value: string, appName?: string, appVersion?: string, dataVersion?: string): boolean;
/** Get a value from the target storage.  For any optional parameter, pass in 'void 0' (without the quotes) to skip/ignore it.
  ...
  * the stored data, the data is reloaded.
  */
export declare function get(type: StorageType, name: string, appName?: string, appVersion?: string, dataVersion?: string): string;
