...
define(["require", "exports", "../Globals"], function (require, exports, Globals_1) {
    ...
    function _storageAvailable(storageType) {
        try {
            var storage = Globals_1.DreamSpace.global[storageType], x = '$__storage_test__$';
            storage.setItem(x, x);
    ...
    exports.hasLocalStorage = _storageAvailable("localStorage");
    /** Set to true if session storage is available. */
    exports.hasSessionStorage = _storageAvailable("sessionStorage");
    // ------------------------------------------------------------------------------------------------------------------
    var StorageType;
    ...
    exports.delimiter = "\uFFFC";
    exports.storagePrefix = "fs";
    function makeKeyName(appName, dataName) {
        if (!dataName)
            throw "An data name is required.";
        if (dataName == exports.delimiter)
            dataName = ""; // (this is a work-around used to get the prefix part only [fs+delimiter or fs+delimiter+appName]])
        return exports.storagePrefix + exports.delimiter + (appName || "") + (dataName ? exports.delimiter + dataName : "");
    }
    exports.makeKeyName = makeKeyName;
    ...
    */
    ...
    function clear(type) {
        var store = getStorage(type);
        var sysprefix = makeKeyName(null, exports.delimiter); // (get just the system storage prefix part)
    ...
    if (Globals_1.DreamSpace.isDebugging() && exports.hasLocalStorage)
