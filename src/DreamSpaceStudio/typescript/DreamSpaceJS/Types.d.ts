 ...
 */
export declare function makeFactory<T extends IType = ObjectConstructor>(obj: T): T & IFactory<T, NewDelegate<InstanceType<T>>, InitDelegate<InstanceType<T>>>;
/**
...
* applied (using the IFunctionInfo interface).
*/
export declare function usingFactory<TFactory extends IFactory>(factory: TFactory, moduleSpace: object, addMemberTypeInfo?: boolean): (cls: IType<object>) => any;
export {};
