...
namespace DreamSpace.Scripts.Modules.System {
    // -------------------------------------------------------------------------------------------------------------------
    // System Plugins 
    ...
    */
    export var UI_HTML = module([UI], '.System.UI.HTML{min:.min}', null); // ('.' will cause 'DreamSpace' to be prefixed automatically)
