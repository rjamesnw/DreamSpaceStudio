...
export declare namespace Browser {
    ...
    */
    ...
    namespace DOM {
        ...
        var onDOMLoaded: import("./Events").IEventDispatcher<typeof DOM, import("./Events").EventHandler>;
        /** True when the DOM has completed loading. */
        function isDOMReady(): boolean;
        /** Fired when a page is loaded, but before it gets parsed. */
        var onPageLoaded: import("./Events").IEventDispatcher<typeof DOM, import("./Events").EventHandler>;
    }
}
