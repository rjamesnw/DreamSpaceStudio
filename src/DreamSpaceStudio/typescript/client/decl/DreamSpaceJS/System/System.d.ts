...
*/
export declare function dispose(obj: IDisposable, release?: boolean): void;
...
* Note: Once 'dispose()' is called on an object, the function is replaced with 'DreamSpace.noop' (if 'keepProperties' is false/undefined) so it cannot be called again.
...
*                          from the object pool each time.
*/
export declare function disposeProperties(obj: Object, skipObjects?: IDisposable[], release?: boolean): void;
