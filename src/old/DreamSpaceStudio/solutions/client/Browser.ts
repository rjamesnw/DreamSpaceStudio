...
namespace DS {
    ...
    export namespace Browser {
        ...
        export namespace DOM {
            ...
            export var onDOMLoaded = new EventDispatcher(DOM, "onDOMLoaded", true);
            ...
            export var onPageLoaded = new EventDispatcher(DOM, "onPageLoaded", true);
            ...
            if (DS.Environment == DS.Environments.Browser) (function () {
                ...
                if (window.addEventListener)
                    ...
                    window.onload = (ev: Event) => { // (perform a hook)
