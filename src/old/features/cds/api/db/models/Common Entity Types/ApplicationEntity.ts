...
public interface ISinglePrimaryKeyEntity {
        ulong ID { get; }
    }

public static class ApplicationExtensions {
    public static KeyBuilder HasKey<TEntity>(this EntityTypeBuilder<TEntity> _this) where TEntity: Application
{
    return _this.HasKey(m => m.ID);
}
    }
